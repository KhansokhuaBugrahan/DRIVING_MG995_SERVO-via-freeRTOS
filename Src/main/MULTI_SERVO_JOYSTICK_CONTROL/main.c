...
void vMyTask3GeneratePulse(void* pvTask3 )
{
	...
	static Servo_Param servo1 = {1440, 1440};
	static Servo_Param servo2 = {1440, 1440};
		    ...
		    GPIO_Handle_t greenLed = {
	              ...
	              GPIO_Handle_t ADC_DIMMER_POT_PA1 = {  .PORTNAME = GPIOA,
				   ...
				   timer3PwmEnable(1440);
					...
					adc1Configuration(ADC_RESOLUTION_12, ADC_MODE_SINGLE_CONV, ADC_CHANNEL_0, ADC_SAMPLING_144_CYCLE);
					adc1Configuration(ADC_RESOLUTION_12, ADC_MODE_SINGLE_CONV, ADC_CHANNEL_1, ADC_SAMPLING_144_CYCLE);
