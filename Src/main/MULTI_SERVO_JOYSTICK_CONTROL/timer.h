...
#define			DUTY_CYCLE_10			2
#define			DUTY_CYCLE_20			4
#define			DUTY_CYCLE_30			6
#define			DUTY_CYCLE_40			8
#define			DUTY_CYCLE_50			10
#define			DUTY_CYCLE_60			12
#define			DUTY_CYCLE_70			14
#define			DUTY_CYCLE_80			16
#define			DUTY_CYCLE_90			18
#define			DUTY_CYCLE_100			20
...
#define		TIMER3_PWM_MODE_2()				(TIMER3->TIMx_CCMR1 |= (0b111 << 4))
...
#define		TIMER3_PWM_ENABLE()				(TIMER3->TIMx_CCER |= ((1u << 0) | (1u << 8)))  // ch1 ch3
#define		TIMER3_PWM_DISABLE()			(TIMER3->TIMx_CCER &= ~((1u << 0) | (1u << 8))) // ch1 ch3
#define     TIMER3_ENABLED()                (TIMER3->TIMx_CCER & (1u << 0))  			    //ch1
