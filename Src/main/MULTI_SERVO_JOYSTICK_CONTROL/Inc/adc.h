...
#define    			ADC1_EOCs_ENABLE()       (ADC_1->ADC_CR2 |= (1u << 10)) /* it allows us to read multiple channel in order
 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	   according to the their sequence no
                                                                            */
...
#define				ADC1_SCAN_MODE_ENABLE()  (ADC_1->ADC_CR1 |= (1u << 8))
