...
void timer3PwmEnable(uint32_t dutyCycle) // channel 1 - channel 2
{
	//channel1 default
	TIMER3_PWM_MODE_1();
	...
	// Channel2 Config
	TIMER3->TIMx_CCMR2 |= (0b110 << 4); // PWM mode 1
	TIMER3->TIMx_CCR3 = dutyCycle;
	TIMER3->TIMx_CCMR2 |= (1u << 3); // preload enable
